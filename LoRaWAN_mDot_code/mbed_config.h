...
#define CLOCK_SOURCE                                                          USE_PLL_HSI                                                                                      // set by target:MTS_MDOT_F411RE
#define EXT_FLASH_ERASE_SIZE                                                  65536                                                                                            // set by library:flash-record-store[MTS_MDOT_F411RE]
#define EXT_FLASH_PAGE_SIZE                                                   256                                                                                              // set by library:flash-record-store[MTS_MDOT_F411RE]
#define EXT_FLASH_SECTOR_SIZE                                                 65536                                                                                            // set by library:flash-record-store[MTS_MDOT_F411RE]
#define FLASH_RECORD_STORE_BANK_SIZE                                          65536                                                                                            // set by library:flash-record-store
#define FLASH_RECORD_STORE_ERASE_ATTEMPTS                                     3                                                                                                // set by library:flash-record-store
#define FLASH_RECORD_STORE_FILE_ENABLE                                        0                                                                                                // set by library:flash-record-store[MTS_MDOT_F411RE]
#define FLASH_RECORD_STORE_JOURNAL_ENABLE                                     1                                                                                                // set by library:flash-record-store[MTS_MDOT_F411RE]
#define FLASH_RECORD_STORE_MULTITHREADED                                      1                                                                                                // set by library:flash-record-store
#define FLASH_RECORD_STORE_READ_ATTEMPTS                                      3                                                                                                // set by library:flash-record-store
#define FLASH_RECORD_STORE_WRITE_ATTEMPTS                                     3                                                                                                // set by library:flash-record-store
#define LORA_APP_LAYER_STACK_SIZE                                             2048                                                                                             // set by library:mdot-library
#define LORA_RADIO_STACK_SIZE                                                 2560                                                                                             // set by library:mdot-library
...
#define MBED_CONF_TARGET_APP_OFFSET                                           0x10000                                                                                          // set by application[MTS_MDOT_F411RE]
